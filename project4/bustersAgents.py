...
class GreedyBustersAgent(BustersAgent):
  ...
  def chooseAction(self, gameState):
    ...
    numGhosts = sum(livingGhosts)
    minPos = (99999999999,99999999999)
    for ghostInd in range(numGhosts):
      gPos = livingGhostPositionDistributions[ghostInd].argMax()
      minPos = min(minPos,gPos)
    ...
    for a in legal:
      ...
      d = self.distancer.getDistance(successorPosition, minPos)
